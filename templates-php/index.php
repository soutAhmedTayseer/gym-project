  ...
  <div class="container" id="pricing">
    ...
    <div class="Price-row">
      <div class="price-col" data-tilt>
        ...
        <button style="margin-top: 110px" id="subscribe-btn1">Subscribe</button>
      </div>
      <div class="price-col" data-tilt>
        <h4>6 Month</h4>
        <h3>$ 2500</h3>
        ...
        <button style="margin-top: 70px" id="subscribe-btn2">Subscribe</button>
      </div>
      <div class="price-col" data-tilt>
        <h4>1 Year</h4>
        <h3>$ 4500</h3>
        ...
        <button id="subscribe-btn3">Subscribe</button>
      </div>
    </div>
  </div>
  <script>
    document.getElementById("subscribe-btn1").onclick = function () {
      window.location.href = "loginsignup.php";
    };
    document.getElementById("subscribe-btn2").onclick = function () {
      window.location.href = "loginsignup.php";
    };
    document.getElementById("subscribe-btn3").onclick = function () {
      window.location.href = "loginsignup.php";
    };
  </script>
