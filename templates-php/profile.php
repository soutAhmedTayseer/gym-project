                    ...
                    <div class="h_leaderboard">
                        <div class="player1">
                            <img class="first" src="../Assets/first.png" alt=""
                                style="    width: 50px; transform: translate(-10px, -7px);">
                            <div class="names">
                        ...
                        <div class="player2">
                            <img class="first" src="../Assets/second.png" alt=""
                                style="    width: 50px; transform: translate(-10px, -7px);">
                            <div class="names">
                                <h6>Amr Alaa</h6>
                            </div>
                        ...
                        <div class="player3">
                            <img class="first" src="../Assets/third.png" alt=""
                                style="    width: 50px; transform: translate(-10px, -7px);">
                            <div class="names">
                                <h6>Karim Mohamed</h6>
                            </div>
                ...
                <div id="price-col4" class="price-col4" data-tilt>
                    <div class="membership">
                        <div class="membership_h">
                            ...
                            <div class="content">
                                <p>start date:&nbsp;&nbsp;21/5/2023</p>
                                <p>end date:&nbsp;&nbsp;&nbsp;21/6/2023</p>
                    ...
                    <div class="streak">
                        <div class="streak_h">
                            ...
                            <div class="content">
                                <p>longest presence streak:&nbsp; 10 days</p>
                                <p>longest absence streak:&nbsp;&nbsp; 5 days</p>
                    ...
                    <div class="extra">
                        <div class="extra_h">
                            ...
                            <div class="content">
                                <p>First date at the gym: &nbsp;21/5/2023</p>
                                <p>anniversary: &nbsp;0 years</p>
